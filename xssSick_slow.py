...
def search_words_in_webpage(url, search_words, user_agent, output_file, timeout=23):
    try:
        ...
        with requests.Session() as session:
            ...
            # Add a delay to limit the rate to 4 requests per second
            time.sleep(0.25)  # 0.25 seconds between requests (4 requests per second)
...
USER_AGENT = r"""Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36"""
